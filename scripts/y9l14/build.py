# -*- coding: utf-8 -*-
"""Slide generator for the Y9 L14 问路 (Asking the Way) deck series.

Six decks, one per classroom lesson, from docs/lesson-plans/y9-l14/.
...
which come from 轻松学中文 3 pp.132–141 and the workbook pp.154–163.
...
Nothing under index/designs/y9-l14/ is hand-maintained except img/, which
scripts/y9l14/art.py owns.
...
Run:  python3 scripts/y9l14/build.py
"""
import os, json, importlib

ROOT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..")
OUT = os.path.join(ROOT, "index", "designs", "y9-l14")
...
def build_deck(slug, title, slides):
    ...
    for n, s in enumerate(slides, 1):
        html = PAGE.format(title="Y9 L14 · " + s["label"], tag=s["tag"],
...
def main():
    ...
    for mod_name in LESSONS:
        mod = importlib.import_module("scripts.y9l14." + mod_name) if __package__ else \
...
TOKENS = """/* ═══════════════════════════════════════════════════
   Y9 L14 · Asking the Way 问路 · 6-lesson deck series
   GENERATED by scripts/y9l14/build.py — do not hand-edit.
...
<title>Y9 L14 · 问路 Asking the Way</title>
...
<header class="hero">
  <div class="container hero-inner">
    <div class="hero-text">
      <span class="unit-tag">Year 9 · Book 3 · Unit 5 · Lesson 14</span>
      <h1>问路</h1>
      <p class="subtitle">Asking the Way · 六节课 · 轻松学中文 3 pp.132–141</p>
      <div class="meta">
  ...
  <section class="grammar-panel">
    ...
    <div class="grammar-grid">
      <div class="grammar-item">
        <p class="g-num">Lessons 1–2</p>
        <p class="g-zh">或者……，或者……</p>
        <p class="g-en">either one way or the other</p>
      </div>
      <div class="grammar-item">
        <p class="g-num">Lessons 2–3</p>
        <p class="g-zh">坐几路车？要坐几站？</p>
        <p class="g-en">a journey by bus, stop by stop</p>
      </div>
      <div class="grammar-item">
        <p class="g-num">Lessons 5–6</p>
        <p class="g-zh">……被……偷了 · 找到了</p>
        <p class="g-en">passive, and whether the action reached its result</p>
      </div>
    </div>
  </section>
...
{{CARDS}}
    ...
    <p class="footnote">
      ...
      <b>No radical or component practice</b>: workbook Ex.&nbsp;9 and Ex.&nbsp;14
      are this lesson's component work and they are out of the decks
      entirely, by the teacher's instruction.
