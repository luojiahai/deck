#!/usr/bin/env bash
# Export the Y8 L13 房子 decks to PPTX and PDF. Run after scripts/y8l13/build.py.
#
...
BASE="index/designs/y8-l13"
DECKS="l1-house-storeys l2-upstairs-rooms l3-downstairs-text1 l4-position-words l5-outside-text2 l6-garage-whole-house"
TMP="$(mktemp -d)"
trap 'rm -rf "$TMP"' EXIT
...
/* ── export copy only — see scripts/y8l13/export.sh ── */
