#!/usr/bin/env bash
# Export the Y8 L14 家具 decks to PPTX and PDF. Run after scripts/y8l14/build.py.
#
...
BASE="index/designs/y8-l14"
DECKS="l1-living-room l2-appliances-inside l3-kitchen-measure-words l4-my-own-room l5-storage-v-not-v l6-furniture-shopping"
TMP="$(mktemp -d)"
trap 'rm -rf "$TMP"' EXIT
...
/* ── export copy only — see scripts/y8l14/export.sh ── */
