#!/usr/bin/env bash
# Export the Y9 L12 decks to PPTX and PDF. Run after scripts/y9l12/build.py.
#
...
BASE="index/designs/y9-l12"
DECKS="l1-buffet-vocab l2-desserts-text1 l3-meal-story l4-ordering-menu l5-cooking-methods l6-drinks-project"
TMP="$(mktemp -d)"
trap 'rm -rf "$TMP"' EXIT
...
/* ── export copy only — see scripts/y9l12/export.sh ── */
